...
@section('content')
                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-left">
                            ...
                            <li class="breadcrumb-item active">Danh sách grade</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
            ...
            <div class="container-fluid">
                ...
                <div class="card card-default">
                    <div class="card-header">
                        <h3 class="card-title">DANH SÁCH GRADE</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <div class="row">
                        ...
                        <!-- Thông báo đã có nhân viên thuộc grade -->
                        ...
                        <table  class="table table-bordered table-hover" style="margin-top: 20px">
                            ...
                            @foreach ($grades as $value)
                                <tr>
                                    <td>{{ $i++ }}</td>
                                    <td class="allow-edit" data-param="grade">
                                        {{ $value->grade }}
                                    </td>
                                    <td>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <button class="btn btn-primary btn-sm"
                                                        ...
                                                        data-href="{!! route('web.grades.update', $value->id) !!}">
                                                    Sửa
                                                </button>
                                            </div>
                                            <div class="col-md-6">
                                                <form method="POST" action="{!! route('web.grades.destroy', [$value->id]) !!}" onsubmit="return confirmDelete()" >
    ...
    <script>
        function confirmDelete() {
            var result = confirm('Bạn có chắc muốn xóa grade này?');
            if (result) {
                return true;
            } else {
                return false;
        ...
        function editGrade(elem) {
            ...
            if (!isEdit) {
                ...
                trCurrent.find('.allow-edit input').each(function () {
                    let rankInput = $(this).attr('name');
                    let value = $(this).val();
                    dataUpdate.push({name: rankInput, value: value});
                });
